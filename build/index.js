...
function EditComponent(props) {
  ...
  function updateTheMeta() {
    const professorsForMeta = wp.data.select("core/block-editor").getBlocks().filter(block => block.name == "ourplugin/featured-professor").map(block => block.attributes.profId).filter((value, index, arr) => {
      return arr.indexOf(value) == index;
    });
    wp.data.dispatch("core/editor").editPost({
      meta: {
        featuredProfessor: professorsForMeta
      }
    });
  }
  const professors = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => {
    return select("core").getEntityRecords("postType", "professor", {
      per_page: -1
    });
  });
  if (professors == undefined) return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Loading...");
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: ""
  }, __("Select a professor", 'featured-professor')), professors.map(professor => {
